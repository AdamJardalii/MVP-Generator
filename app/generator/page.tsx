...
export default function GeneratorPage() {
  ...
  const generatorUrl = `${basePath}/generator/index.html`
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#fafafa] dark:bg-[#0a0a0a]">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Loading Generator...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#fafafa] dark:bg-[#0a0a0a]">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">MVP Website Generator</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Create beautiful e-commerce websites with bilingual support and WhatsApp integration.
          </p>
          <a 
            href={generatorUrl} 
